                    ...
                    <table className="table leave-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span className="date-line">2024-07-15</span>
                                </td>
                                <td>Family emergency</td>
                                <td><span className="pill pending">Pending</span></td>
                                <td className="actions">
                                    <button className="action-icon approve"><FaCheck /></button>
                                    <button className="action-icon reject"><FaTimes /></button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><span className="date-line">2024-07-22</span></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span className="date-line">2024-07-22</span>
                                </td>
                    ...
                    <table className="table leave-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Travel</td>
                                <td><span className="pill rejected">Rejected</span></td>
                            </tr>
